...
defaultDirPath = "C:\Temp"
defaultFileName = "\AFOF_log.txt"
defaultFilePath = defaultDirPath + defaultFileName
...
def getTimeStampForFileName():
  ...
  logPrefix = logPrefix + "_" + str(now_TS.hour) + "_" + str(now_TS.minute) + "_" + str(now_TS.second)
  return logPrefix
