...
/**
 * SkillEventManagerListener
 *
 * EventManagerListener implementation used by the OPC UA server.
 * No added functionality over example provided by Prosys.
 *
 */
public class SkillEventManagerListener implements EventManagerListener {
	
	private static final Logger logger = LoggerFactory.getLogger(SkillEventManagerListener.class);
