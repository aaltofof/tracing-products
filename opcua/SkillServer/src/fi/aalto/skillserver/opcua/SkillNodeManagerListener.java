...
/**
 * SkillNodeManagerListener
 * 
 * Implementation of NodeManagerListener used by the OPC UA server
 * for the skills. Unmodified from the Prosys example.
 * 
 */
public class SkillNodeManagerListener implements NodeManagerListener {
