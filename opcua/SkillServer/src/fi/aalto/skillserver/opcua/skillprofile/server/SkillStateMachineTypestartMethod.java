...
public abstract interface SkillStateMachineTypestartMethod {
  void start(ServiceContext serviceContext, SkillStateMachineTypeNode node) throws StatusException;
}
