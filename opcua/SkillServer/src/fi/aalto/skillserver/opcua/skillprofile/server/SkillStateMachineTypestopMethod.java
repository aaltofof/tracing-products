...
public abstract interface SkillStateMachineTypestopMethod {
  void stop(ServiceContext serviceContext, SkillStateMachineTypeNode node) throws StatusException;
}
