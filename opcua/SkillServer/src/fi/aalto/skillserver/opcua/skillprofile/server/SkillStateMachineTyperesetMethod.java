...
public abstract interface SkillStateMachineTyperesetMethod {
  void reset(ServiceContext serviceContext, SkillStateMachineTypeNode node) throws StatusException;
}
