...
public abstract interface SkillStateMachineTypeLockMethod {
  void lock(ServiceContext serviceContext, SkillStateMachineTypeNode node) throws StatusException;
}
