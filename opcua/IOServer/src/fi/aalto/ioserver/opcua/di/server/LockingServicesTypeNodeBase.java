...
import fi.aalto.ioserver.opcua.di.LockingServicesType;
...
public abstract class LockingServicesTypeNodeBase extends BaseObjectTypeNode implements LockingServicesType {
  ...
  protected abstract Integer onInitLock(ServiceContext serviceContext, String context) throws
      StatusException;

  @Override
  public Integer initLock(String context) throws StatusException {
    return doInitLock(ServiceContext.INTERNAL_OPERATION_CONTEXT, context);
  }

  private Integer doInitLock(ServiceContext serviceContext, String context) throws StatusException {
    LockingServicesTypeInitLockMethod impl = getInitLockMethodImplementation();
    if(impl != null) {
      return impl.initLock(serviceContext, (LockingServicesTypeNode)this, context);
    } else {
      return onInitLock(serviceContext, context);
    }
  }
