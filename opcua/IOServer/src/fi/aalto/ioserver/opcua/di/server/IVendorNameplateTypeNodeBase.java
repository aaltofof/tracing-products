...
import fi.aalto.ioserver.opcua.di.IVendorNameplateType;
...
public abstract class IVendorNameplateTypeNodeBase extends BaseInterfaceTypeNode implements IVendorNameplateType {
  private static GeneratedNodeInitializer<IVendorNameplateTypeNode> iVendorNameplateTypeNodeInitializer;

  protected IVendorNameplateTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    GeneratedNodeInitializer<IVendorNameplateTypeNode> impl = getIVendorNameplateTypeNodeInitializer();
    if(impl != null) {
      impl.init((IVendorNameplateTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<IVendorNameplateTypeNode> getIVendorNameplateTypeNodeInitializer() {
    return iVendorNameplateTypeNodeInitializer;
  }

  public static void setIVendorNameplateTypeNodeInitializer(GeneratedNodeInitializer<IVendorNameplateTypeNode> iVendorNameplateTypeNodeInitializerNewValue) {
    iVendorNameplateTypeNodeInitializer=iVendorNameplateTypeNodeInitializerNewValue;
  }
