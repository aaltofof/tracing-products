...
public class IceBlockTypeNode extends IceBlockTypeNodeBase {
  protected IceBlockTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
