...
/**
 * IOEventManagerListener
 *
 * EventManagerListener implementation used by the OPC UA server.
 * No added functionality over example provided by Prosys.
 *
 */
public class IOEventManagerListener implements EventManagerListener {
	
	private static final Logger logger = LoggerFactory.getLogger(IOEventManagerListener.class);
